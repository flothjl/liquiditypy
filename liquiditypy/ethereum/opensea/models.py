...
class AssetContract:
    def __init__(self, asset_contract: dict):
        ...
        self.dev_seller_fee_basis_pts = asset_contract.get(
            "dev_sellet_fee_basis_points"
        )
        self.dev_buyer_fee_basis_pts = asset_contract.get("dev_buyer_fee_basis_points")
        self.opensea_seller_fee_basis_pts = asset_contract.get(
            "opensea_sellet_fee_basis_points"
        )
        self.opensea_buyer_fee_basis_pts = asset_contract.get(
...
class OpenSeaAssetEvent:
    def __init__(self, open_sea_event: dict):
        ...
        self.payment_token: PaymentToken = PaymentToken(
            open_sea_event.get("payment_token", {})
        )
